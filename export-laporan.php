...
$sheet->setCellValue('D1', 'NANMA TAMU');
...
if (isset($_GET['cari'])) {
    ...
    $data = mysqli_query($koneksi, "SELECT * FROM daftar_tamu_smakji WHERE tanggal BETWEEN '$p_awal' AND '$p_akhir'");
} else {
    $data = mysqli_query($koneksi, "SELECT * FROM daftar_tamu_smakji");
}
